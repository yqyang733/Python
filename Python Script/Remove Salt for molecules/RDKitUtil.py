...
__all__ = ["AreAtomIndicesSequentiallyConnected", "AreAtomMapNumbersPresentInMol", "AreHydrogensMissingInMolecule", "ClearAtomMapNumbers", "ConstrainAndEmbed", "FilterSubstructureMatchByAtomMapNumbers", "FilterSubstructureMatchesByAtomMapNumbers", "GetAtomMapIndices", "GetAtomMapIndicesAndMapNumbers", "GetAtomSymbols", "GetAtomPositions", "GetFormalCharge", "GetInlineSVGForMolecule", "GetInlineSVGForMolecules", "GetMolName", "GetSpinMultiplicity", "GetSVGForMolecule", "GetSVGForMolecules", "GetPsi4XYZFormatString", "GenerateBase64EncodedMolStrings", "GenerateBase64EncodedMolStringWithConfIDs", "IsAtomSymbolPresentInMol", "IsMolEmpty", "IsValidElementSymbol", "MolFromBase64EncodedMolString", "GenerateBase64EncodedMolStringsWithIDs", "MolToBase64EncodedMolString", "MolFromSubstructureMatch", "MolsFromSubstructureMatches", "ReadMolecules", "ReadAndValidateMolecules", "ReadMoleculesFromSDFile", "ReadMoleculesFromMolFile", "ReadMoleculesFromMol2File", "ReadMoleculesFromPDBFile", "ReadMoleculesFromSMILESFile", "SetAtomPositions", "SetWriterMolProps", "ValidateElementSymbols", "WriteMolecules"]
...
def GetPsi4XYZFormatString(Mol, ConfID = -1, FormalCharge = "auto", SpinMultiplicity = "auto", Symmetry = "auto", NoCom = False, NoReorient = False,):
    ...
    AtomSymbols = GetAtomSymbols(Mol)
    AtomPositions = GetAtomPositions(Mol, ConfID)
    ...
    if re.match("^auto$", FormalCharge, re.I):
        FormalCharge = GetFormalCharge(Mol)
    else:
        FormalCharge = int(FormalCharge)
    
    if re.match("^auto$", SpinMultiplicity, re.I):
        SpinMultiplicity = GetSpinMultiplicity(Mol)
    else:
        SpinMultiplicity = int(SpinMultiplicity)
    
    GeometryList.append("%s %s" % (FormalCharge, SpinMultiplicity))
